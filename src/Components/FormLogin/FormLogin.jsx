    ...
    <div className='flex items-center justify-center h-screen bg-slate-900 '>
      <form className='form-container h-3/4 flex flex-col justify-center bg-slate-600 rounded-lg' onSubmit={handleSubmit}>
        ...
        <label className='block p-2'>
            ...
            <input type='text' name='name' ref={emailRef} className='mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1' placeholder='Tony' />
          </label>
          <label className='block p-2'>
            <span className="after:content-'*' after:ml-0.5 after:text-red-500 block text-sm font-medium text-white">
              LastName
            </span>
            <input type='text' name='lastname' ref={emailRef} className='mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1' placeholder='Stark' />
          </label>
          <label className='block p-2'>
            <span className="after:content-'*' after:ml-0.5 after:text-red-500 block text-sm font-medium text-white">
              Email
          ...
          <select 
          ref={countryRef}
          className='mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1' name="pais">
